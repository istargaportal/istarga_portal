 ...
 ';
	...
	while($row = $result->fetch_assoc())
    {
        ...
        <tr>
	        ...
	        <td class="tablehead1"><a class="btn btn-primary btn-xs" onclick="load_service_order('.$row["order_service_details_id"].', '.$row["order_verify_id"].')" ><i class="fa fa-external-link"></i> '.$row["case_reference_no"].'</a></td>
