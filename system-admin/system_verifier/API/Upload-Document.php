...
if(isset($_FILES['document_file']))
{
    ...
    foreach ($_FILES['document_file'] as $document_file_s)
    {
        ...
        if(empty($errors)==true)
        {
            ...
            {
                $sql = "INSERT INTO order_master_uploded_documents(order_id, file_name, file_size, file_type, file_ext, document_file, uploaded_by, verifier_user_id, user_id) VALUES('$order_id', '$file_name_old', '$file_size', '$file_type', '$file_ext', '$file_name', 'Verifier', '$user_id', '$user_id')  ";
