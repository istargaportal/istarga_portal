...
$check = "SELECT prefix, first_name, middle_name, last_name, date_of_birth, employee_id, profile_pic, permanent_address, email_id, contact_number, date_of_join, alternate_contact, adhar_number, pan_number, passport_number, bank_name, account_number, ifsc_code FROM user_master ";
