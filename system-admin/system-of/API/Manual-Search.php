...
if($_POST['action'] == 'load_manual_search')
{
 ...
 ';
    ...
    $sq.=" AND (os.of_user_id = 0 OR os.of_user_id = '$user_id') GROUP BY os.order_service_details_id";
	...
	while($row = $result->fetch_assoc())
    {
        ...
        if($row["of_closure_date"] != "0000-00-00") { $row["of_closure_date"] = date('d-m-Y', strtotime($row["of_closure_date"])); }
