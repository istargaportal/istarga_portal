...
if(@$load_condition == "import_bulk_order")
{
	...
	if ($query_res1 > 0) 
	{
		...
		foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
		{
		    ...
		    {
			    $internal_reference_id = $worksheet->getCellByColumnAndRow(1, $row);
			    $applicant_name = $worksheet->getCellByColumnAndRow(2, $row);
		    	...
		    	if($service_id == 2)
		    	{
			    	$college_name = $worksheet->getCellByColumnAndRow(3, $row);
			    	$university = $worksheet->getCellByColumnAndRow(4, $row);
			    	$degree = $worksheet->getCellByColumnAndRow(5, $row);
			    	$year_of_passing = $worksheet->getCellByColumnAndRow(6, $row);
			    	$register_number = $worksheet->getCellByColumnAndRow(7, $row);
			    	$researcher_name = $worksheet->getCellByColumnAndRow(8, $row);
			    	$employee_id = $worksheet->getCellByColumnAndRow(9, $row);
			    	$country = $worksheet->getCellByColumnAndRow(10, $row);
			    	$graduated = $worksheet->getCellByColumnAndRow(11, $row);
			    	$customer_type = $worksheet->getCellByColumnAndRow(12, $row);
			    	$additional_comments = $worksheet->getCellByColumnAndRow(13, $row);
		    	...
		    	{
			    	$date_of_birth = $worksheet->getCellByColumnAndRow(3, $row);
		    		$date_of_birth = str_replace('/', '-', $date_of_birth);
			    	$address = $worksheet->getCellByColumnAndRow(4, $row);
			    	$father_name = $worksheet->getCellByColumnAndRow(5, $row);
			    	$customer_type = $worksheet->getCellByColumnAndRow(6, $row);
			    	$additional_comments = $worksheet->getCellByColumnAndRow(7, $row);
