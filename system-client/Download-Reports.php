        ...
        <div class="card-body">
          <div class="row col-md-12">
            ...
            <div class="col-md-6">
              ...
              <label class="container_checkbox" >
                <input style=" cursor: pointer;" class="form-check-input" type="radio" value="check_level" name="report_level" id="check_report_level">
                Check Level
                <span class="checkmark"></span>
              </label>
              <label class="container_checkbox" >
                <input style=" cursor: pointer;" class="form-check-input" type="radio" value="both" name="report_level" id="both_report_level">
                Both
                <span class="checkmark"></span>
              </label>
            </div>
